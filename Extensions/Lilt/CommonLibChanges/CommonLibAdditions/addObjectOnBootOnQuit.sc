...
+ Object {
	...
	onBootOrReset { | argAction, argServer, doNowIfRunning = false |
		ServerWatcher.onBootOrReset(this, argAction, argServer, doNowIfRunning);
	}
...
+ Function {
	...
	onBoot { | argServer, doNowIfRunning = true |
		ServerWatcher.onBoot(this, this, argServer, doNowIfRunning);
	}

	onBootOrReset { | argServer, doNowIfRunning = true |
		ServerWatcher.onBootOrReset(this, this, argServer, doNowIfRunning);
	}

	onReset { | argServer, doNowIfRunning = true |
		ServerWatcher.onReset(this, this, argServer, doNowIfRunning);
	}

	onQuit { | argServer, doNowIfStopped = true |
