...
1. Ascending leaf numbers, smaller branches first: 

	generated by: 		next = [prev, current + 1]; prev = current;

	[ [ 1, [ 2, 3 ] ], [ [ 2, 3 ], [ 3, [ 4, 5 ] ] ] ]

2. Ascending leaf numbers, larger branches first: 

	generated by: 		next = [current, prev + 1]; prev = current + 1;

	[ [ [ [ 1, 2 ], 3 ], [ 3, 4 ] ], [ [ 3, 4 ], 5 ] ]

3. Descending leaf numbers, smaller branches first: 

	generated by:			next = [prev + 1, current]; prev = current + 1;

	[ [ 5, [ 4, 3 ] ], [ [ 4, 3 ], [ 3, [ 2, 1 ] ] ] ]

4. Descending leaf numbers, larger branches first: 
