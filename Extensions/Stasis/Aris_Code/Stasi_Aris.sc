...
Stasi_Aris	{
	...
	*new { | server, addr, chan = 0 |
	...
	soundGUI	{
		...
		//numSoundSketches
		numSoundSketches=EZSlider(wSound, 300@20, "numSoundSketches ", ControlSpec(1, 99, \lin, 1, 5), numberWidth:50,layout:\horz, initVal:99, labelWidth: 120);
	...
	mainGUI	{
		...
		//numMouseSketches
		numMouseSketches=EZSlider(window, 300@20, "numMouseSketches ", ControlSpec(1, 99, \lin, 1, 5), numberWidth:50,layout:\horz, initVal:99, labelWidth: 120);
