...
A very similar class exists in Lilt version 1 (quark). The present class renamed to TextDialog2 and will be removed at some point (status = deprecated). 

TextDialog2("just some test", "input some text here", { | t | t.postln; "was okd".postln; }, { "cancelled".postln; });
