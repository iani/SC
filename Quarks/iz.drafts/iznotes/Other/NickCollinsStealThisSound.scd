...
Ê Ê Ê Ê var osc, filter, env, filterenv;

Ê Ê Ê Ê osc = Mix(Pulse.ar(freq.lag(0.05)*[1.0,1.001,3.0,5.0],Rand(0.45,0.5)!4,0.33));

Ê Ê Ê Ê filterenv = EnvGen.ar(Env.adsr(attackTime,0.0,1.0,1.0),gate,doneAction:2);
Ê Ê Ê Ê filter = ÊMoogFF.ar(osc,cutoff*(1.0+(fenvamount*filterenv)),gain);

Ê Ê Ê Ê env = EnvGen.ar(Env.adsr(0.001,0.3,0.9,1.2),gate,doneAction:2);

Ê Ê Ê Ê Out.ar(out,Pan2.ar((0.7*filter+(0.3*filter.distort))*env*amp,pan));

}).add;

SynthDef(\eightoeightkick,{|out= 0 freq = 440 amp = 0.1 ringTime=10.0 releaseTime=1.0 distortion = 0.1 pan=(-0.1)|

Ê Ê Ê Ê var impulse, filter, env;

Ê Ê Ê Ê impulse = Impulse.ar(0);

Ê Ê Ê Ê filter = Ringz.ar(impulse,XLine.ar(freq,60,0.1),ringTime);

Ê Ê Ê Ê env = EnvGen.ar(Env.perc(0.001,releaseTime),doneAction:2);

Ê Ê Ê Ê filter = (1.0-distortion)*filter + (distortion*(filter.distort));
Ê Ê Ê Ê Out.ar(out,Pan2.ar(filter*env*amp,pan));
...
Ppar([
Ê Ê Ê Ê Pbind(
Ê Ê Ê Ê Ê Ê Ê Ê \instrument,\eightoeightkick,
Ê Ê Ê Ê Ê Ê Ê Ê \dur,Pseq(1.0!8++[0.5],inf),
Ê Ê Ê Ê Ê Ê Ê Ê \amp,0.6,
Ê Ê Ê Ê Ê Ê Ê Ê \releaseTime,Pstutter(4,Pn(Pseries(2.0,-0.3,6),inf)),
Ê Ê Ê Ê Ê Ê Ê Ê \ringTime,Pstutter(6,Pn(Pseries(10.0,-1.0,9),inf)),
Ê Ê Ê Ê Ê Ê Ê Ê \distortion,Pstutter(7,Pn(Pseries(0.1,0.2,4),inf))
Ê Ê Ê Ê ),

Ê Ê Ê Ê Pbind(
Ê Ê Ê Ê Ê Ê Ê Ê \instrument, \moogbasstone2,
Ê Ê Ê Ê Ê Ê Ê Ê \attackTime,0.02,
Ê Ê Ê Ê Ê Ê Ê Ê \amp, Prand([0.8,0.7,0.3],inf),
Ê Ê Ê Ê Ê Ê Ê Ê \midinote,Pstutter(2,Prand([36,39,39.1,39.2,48,48.1,43,43.1,31,36.1,36.2],inf)),
Ê Ê Ê Ê Ê Ê Ê Ê \dur,Pseq(0.5!8++(0.25!7),inf),
Ê Ê Ê Ê Ê Ê Ê Ê \gain,Pstutter(2,Pn(Pseries(2,0.1,19),inf)),
Ê Ê Ê Ê Ê Ê Ê Ê \cutoff,Pstutter(4,Pn(Pseries(50,250,30),inf)),
Ê Ê Ê Ê Ê Ê Ê Ê \fenvamount,Pstutter(4,Pn(Pseries(0.0,0.05,20),inf))
Ê Ê Ê Ê )
]
).play
