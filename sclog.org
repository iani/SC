...
**** TODO add chain, Udef, Ubuf to load synthdefs and buffers before creating a synth :uniqueobject:
     :PROPERTIES:
...
*/
*** 2011-04-26 Tuesday
**** TODO add doOnce and forkOnce methods to function 	     :uniquefunction:
     :PROPERTIES:
...
**** TODO decouple coloring scheme from Panes and add it to non-gittable private startup file  :panes:
     ...
     :END:
**** TODO debug Symbol:synth method 				:uniquesynth:
     :PROPERTIES:
